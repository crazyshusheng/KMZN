...
class PasswordAlertView: UIView,UITextFieldDelegate {
    ...
    func setupUI() {
        ...
        pwdView.layer.borderColor = UIColor.lightGray.cgColor
...
//        sureButton.layer.cornerRadius = 5
   ...
   @objc func sure(sender:UIButton) {
    ...
    @objc func keyBoardWillShow(Info:NSNotification) {
        ...
        self.BGView.center = CGPoint.init(x: self.BGView.center.x , y:self.frame.size.height - heigh - self.BGView.frame.size.height/2 - 20 )
    }
